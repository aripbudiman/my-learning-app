...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 128 128">
        <path fill="#c62828"
            d="m70.24 100.79l48.55 4.62c4.57.44 5.74-2.11 5.74-4.27l-.05-2.62l-59.71-8.42c0 2.99 2.43 10.69 5.47 10.69" />
        <path fill="#f44336"
            d="m72.01 98.51l7.64.67l40.91 3.95c2.2 0 3.97-1.75 3.97-3.91l-2.17-66.26c0-2.16-1.78-3.91-3.97-3.91l-46.38-4.38c-3.04 0-5.51 2.43-5.51 5.42v63c0 2.99 2.46 5.42 5.51 5.42" />
        <path fill="#c62828"
            d="m57.76 100.79l-48.55 4.62c-4.57.44-5.74-2.11-5.74-4.27l.05-2.62l59.71-8.43c0 3-2.43 10.7-5.47 10.7" />
        <path fill="#f44336"
            d="m55.99 98.51l-7.58.67l-40.97 3.96c-2.2 0-3.97-1.75-3.97-3.91l2.17-66.26c0-2.16 1.78-3.91 3.97-3.91l46.38-4.38c3.04 0 5.51 2.43 5.51 5.42v63c0 2.98-2.46 5.41-5.51 5.41" />
        <path fill="#424242" d="M78.75 83.68H49.27l-.9 15.53l9.2.86s1.97 4.92 6.43 4.92s6.43-4.92 6.43-4.92l9.2-.86z" />
        <path fill="none" stroke="#616161" stroke-miterlimit="10" stroke-width="2.5"
            d="m79.54 100.43l-8.57-.74m-22.51.74l8.57-.74" />
        <path fill="#94c6d6"
            d="m119.65 32.82l-4-5.5L64 86.02l-51.65-58.7l-4 5.5l-.56 65.35s10.62 1.33 24.81-.11c12.36-1.25 18.18-4.45 22.31-3.62c4.96 1 5.86 4.05 6.02 4.57c.45 1.44 1.34 2.56 3.07 2.56s2.5-.6 3.03-2.38c.16-.52 1.1-3.74 6.06-4.74c4.13-.83 9.95 2.37 22.31 3.62c14.19 1.44 24.81.11 24.81.11z" />
        <linearGradient id="SVGzsROGc9y" x1="50.885" x2="50.638" y1="88.201" y2="70.898"
            gradientTransform="matrix(-1 0 0 1 168.128 0)" gradientUnits="userSpaceOnUse">
            <stop offset=".267" stop-color="#82aec0" />
            <stop offset="1" stop-color="#82aec0" stop-opacity="0" />
        </linearGradient>
        <path fill="url(#SVGzsROGc9y)" d="m114.3 91.87l.16-26.39h5.47l.28 32.69s-4.35-1.69-5.91-6.3" />
        <linearGradient id="SVGxxMokXli" x1="98.211" x2="55.4" y1="84.601" y2="84.601"
            gradientTransform="matrix(-1 0 0 1 168.128 0)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#2f7889" />
            <stop offset="1" stop-color="#82aec0" />
        </linearGradient>
        <path fill="url(#SVGxxMokXli)"
            d="m114.55 76.49l-.25 15.39s-11.96-.62-31.01-3.92C70.83 85.8 64 92.72 64 92.72l-.11-16.23z" />
        <linearGradient id="SVG4cd94W3I" x1="57.979" x2="15.263" y1="84.601" y2="84.601" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#2f7889" />
            <stop offset="1" stop-color="#82aec0" />
        </linearGradient>
        <path fill="url(#SVG4cd94W3I)"
            d="m13.45 76.49l.25 15.39s11.96-.62 31.01-3.92C57.17 85.8 64 92.72 64 92.72l-.11-16.23z" />
        <linearGradient id="SVGygWXGUse" x1="10.753" x2="10.505" y1="88.201" y2="70.898" gradientUnits="userSpaceOnUse">
            <stop offset=".267" stop-color="#82aec0" />
            <stop offset="1" stop-color="#82aec0" stop-opacity="0" />
        </linearGradient>
        <path fill="url(#SVGygWXGUse)" d="m13.7 91.87l-.16-26.39H8.06l-.27 32.69s4.34-1.69 5.91-6.3" />
        <path fill="#f5f5f5"
            d="M115.65 27.32s-26.54-4.99-38.19-5.64c-10.96-.61-13.21 4.97-13.43 5.64h-.04c-.23-.67-2.48-6.24-13.44-5.64c-11.65.65-38.19 5.64-38.19 5.64l-1.18 64.4s31.6-6.62 39.25-5.76S64 92.72 64 92.72v-.01v.01s5.93-5.9 13.58-6.76s39.25 5.76 39.25 5.76z" />
        <path fill="#94c6d6"
            d="m53.62 21.69l-5.4 64.2c.85-.02 1.6 0 2.2.07c7.64.85 13.58 6.76 13.58 6.76l-.17-65.4s-1.3-5.12-10.21-5.63"
            opacity="0.26" />
        <path fill="#757575"
            ...
            opacity="0.5" />
        <path fill="#616161"
            d="M71.16 98.45c-1.12-.1-2.15.59-2.51 1.66c-.54 1.63-1.8 3.76-4.65 3.76c-2.88 0-4.15-2.14-4.7-3.77a2.415 2.415 0 0 0-2.48-1.64l-.39.03l.01.32a7.55 7.55 0 0 0 7.55 7.55a7.55 7.55 0 0 0 7.55-7.55c0-.1-.01-.33-.01-.33z" />
    </svg>
</template>